...
Creates an AWS Transit Gateway Route Table Association. 
...
---
- name: "Create a Transit Gateway Route Table Association"
  hosts: localhost
  gather_facts: false
  collections:
    - custom_aws.ec2
...
- name: "Create a Transit Gateway Route Table"
  ...
  gather_facts: false
  roles:
    - { role: custom_aws.ec2.transit_gateway_route_table_association, tgw_rtb_id: tgw-rtb-123456789, tgw_attach_id: tgw-attach-12346789 }
...
