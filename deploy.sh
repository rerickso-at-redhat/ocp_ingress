...
CLUSTERA="api.cluster-52rbh.dynamic.redhatworkshops.io:6443"
CLUSTERB="api.cluster-fgt68.dynamic.redhatworkshops.io:6443"
...
function wait_for_operator () {
	OPERATOR_NAME=$1
        until [ $(oc get csv -n openshift-operators | grep $OPERATOR_NAME > /dev/null; echo $?) == 0 ]; do echo "Waiting for operator: $OPERATOR_NAME"; sleep 5; done
